...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="col-md-10 offset-md-1">
        <div class="card">
            <div class="card-header"><h5>Agregar Cliente</h5></div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form method="POST" action="{{ route('clientes.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nombre_contacto" name="nombre_contacto" value="{{ old('nombre_contacto') }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="email_contacto" class="form-label">Email Contacto</label>
                        <input type="email" class="form-control" id="email_contacto" name="email_contacto" value="{{ old('email_contacto') }}" required>
                    </div>
