            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('users.update', $user) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="rut" name="rut" value="{{ old('rut', $user->rut) }}" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $user->email) }}" required placeholder="nombre.apellido@ventasfix.cl" readonly>
                    </div>
                    <script>
